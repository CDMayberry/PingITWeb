...
var appId = 'EEC4E7E6-2738-45D8-85F7-E0DF5D3584DE';
...
function startSendBird(guestId, nickName) {
	console.log(guestId);
	//parse show logged in
	//start parse when sendbird starts
	Parse.initialize("kddcodGlyJ6DmGI7FihXt8BsXyOTS09Dgpj8UA49", "mELQYuj5f9MYNUlfEDZoIvCwS2VGg0l7TloEJHJS");
	var AdminTimes = Parse.Object.extend("AdminTimes");
	var adminTimes = new AdminTimes();
	adminTimes.set("userName",guestId);
	adminTimes.set("timeOfLastAction",new Date());
	adminTimes.set("friendlyName",nickName);
	
	adminTimes.save(null,{
		success: function(adminTimes) {
			// Execute any logic that should take place after the object is saved.
			console.log('New object created with objectId: ' + adminTimes.id);
		...
		error: function(adminTimes, error) {
